...
impl Debugger {
    ...
    ///
    /// # Errors
    /// Writing to the instrument can fail
    ...
    ///
    /// # Errors
    /// The write to the instrument may fail
    ...
    ///
    /// # Panics
    /// If provided script filenames are not valid files, there is nothing that can be
    /// done, so we panic and exit.
